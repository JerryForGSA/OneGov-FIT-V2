 ...
 *                     └── Entity Profiles (19u-Ht0ac6BwWvOuQfgERHkjk6VwqJPih) [All profiles saved here - RENAMED FOLDER]
 */
 ...
 * Updated column structure: Key | View | Profile Type | Letterhead | Profile Link | Generated By | Generation Timestamp
 */
...
function renderTemplateAsHTML(templateId, placeholders, letterhead) {
  try {
    console.log(`🔗 Rendering HTML preview using F06_ExecutiveProfile.html template`);
    
    // Use the F06_ExecutiveProfile.html file as the base template for preview
...
function generateFullHTMLDocument(placeholders, profileType, letterhead, entityData) {
  try {
    // Read the F06_ExecutiveProfile.html template and replace placeholders
...
/**
 * Test profile logging with new letterhead column
 */
function testProfileLogging() {
  console.log('=== Profile Logging Test ===');
  
  try {
    // Test GSA letterhead
    logProfileGeneration(
      'Entity Profile', 
      'OEM', 
    ...
    console.log('✅ GSA letterhead logging test completed');
    
    // Test ITVMO letterhead  
    logProfileGeneration(
      'Entity Profile',
      'Vendor', 
      'https://docs.google.com/document/d/test-doc-id-2/edit',
      'Test Company ITVMO',
      'ITVMO'
    );
    console.log('✅ ITVMO letterhead logging test completed');
    
    console.log('=== Check the Profile Log sheet for new entries with letterhead column ===');
